"""
PA4:
Develop a classification CNN architecture which has more than 2 layers 
and more than 1 fully connected layers.

It should make 10 predictions for the 0 classes of CIFAR-10.
Train for 30 epochs.
Use cross-entropy loss and SGD optimizer
Remember to use softmax activation after the final fully connected layer.

Part 2:
increase the number of convolution layers in the network and train it again.
"""
